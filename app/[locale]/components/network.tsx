...
const World_map = dynamic(() => import("./worldMap"), {
    ssr: false,
    loading: () => <></>,
});
...
export default function Network() {
    ...
    return (
        <section className="w-dvw min-h-dvh bg-(--clr-surface) flex max-lg:flex-col justify-center items-center px-16 max-lg:p-16 max-md:px-6 gap-16">
            ...
            <div className="w-1/2 max-lg:w-full max-h-125  h-2/3 bg-(--clr-surface2) flex justify-center items-center rounded-2xl border-2 border-(--clr-surface-light2) relative">
                <World_map />
            </div>
        </section>
    );
