...
export default function Correct(props: svg_props) {
	return (
		<svg fill={props.color || "black"} className={props.css} width={`${props.s || props.w}px` || "50px"} height={`${props.s || props.h}px` || "50px"} viewBox="0 0 200 200" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
