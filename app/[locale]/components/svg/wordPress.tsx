...
export default function WordPress(props: svg_props) {
	return (
		<svg className={props.css} width={`${props.s || props.w}px` || "50px"} height={`${props.s || props.h}px` || "50px"} stroke="none" fill={props.color} viewBox="0 0 512 512" enableBackground="new 0 0 512 512">
			<g id="5151e0c8492e5103c096af88a51f5fb6">
				<path
					display="inline"
					d="M256,0.5C115.117,0.5,0.5,115.109,0.5,255.992C0.5,396.874,115.117,511.5,256,511.5
		...
		// 	<rect x="2" y="4" width={`${(props.s && props.s * 0.625) || (props.w && props.w * 0.625)}px` || "32px"} height={`${(props.s && props.s * 0.5) || (props.w && props.w * 0.5)}px` || "25px"} rx="2"></rect>
		// 	<path d="M10 4v4"></path>
		// 	<path d="M2 8h20"></path>
		// 	<path d="M6 4v4"></path>
		// </svg>
