...
export default function Language(props: svg_props) {
    return (
        <svg className={props.css} width={`${props.s || props.w}px` || "50px"} height={`${props.s || props.h}px` || "50px"} stroke="none" fill={props.color || "currentColor"} viewBox="0 0 512 512">
