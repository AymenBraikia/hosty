...
export default function Button(props: { type?: "submit" | "button" | "reset"; children_el?: React.JSX.Element; url?: string; action?: (e: React.MouseEvent) => void; content: string; styles?: React.CSSProperties; css?: string }) {
