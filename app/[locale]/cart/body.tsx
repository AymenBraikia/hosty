...
import { editCart } from "../actions/edit_cart";
                ...
                <>
                    ...
                    <div className="flex justify-center items-start gap-8 w-full">
                        <div className="flex justify-start items-start flex-col gap-8 w-full h-[75dvh] overflow-auto">
                            {items.map((e) => {
                                return (
                                    <div key={"name" in e ? e.name : e.id} className="w-full p-4 flex justify-between items-center border border-(--clr-surface-light2) rounded-2xl">
